        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            },
            {
              ...
              desc: "Select your favorites and let Poster rotate them automatically. Works in the background from your system tray."
            },
            {
      ...
      <section id="changelog" className="py-24 px-6 bg-surface-2/30 border-y border-border-custom">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="flex gap-6 p-6 rounded-2xl bg-surface border border-border-custom hover:shadow-md transition-shadow">
               ...
               <div>
                 <div className="flex items-center gap-3 mb-2">
                   <h3 className="text-xl font-bold text-text-primary">v1.1.4 - Auto-Update State Recovery & Live Search</h3>
                   <span className="text-xs font-semibold bg-accent-muted text-accent px-2 py-1 rounded-md">Latest</span>
                 </div>
                 <p className="text-text-secondary text-sm leading-relaxed">Introducing a premium live search dropdown to instantly find wallpapers by name or tag. The background auto-update system has been completely rebuilt with robust state recovery, ensuring your downloads safely persist even if you leave the Settings page, and giving you manual control over when the app restarts.</p>
               </div>
            </div>
            ...
            <div className="flex gap-6 p-6 rounded-2xl bg-surface border border-border-custom hover:shadow-md transition-shadow opacity-75">
               <div className="hidden sm:flex flex-col items-center">
                 <div className="w-12 h-12 rounded-full bg-surface-2 flex items-center justify-center text-text-muted font-bold text-sm mb-2 pt-1 uppercase tracking-wider">v1</div>
                 <div className="w-0.5 h-full bg-border-custom/50 rounded-full"></div>
               </div>
               <div>
                 <div className="flex items-center gap-3 mb-2">
                   <h3 className="text-xl font-bold text-text-primary">v1.0.5 - Ultimate Reliability</h3>
                 </div>
                 <p className="text-text-secondary text-sm leading-relaxed">Added robust system-native fallbacks (PowerShell for Windows and AppleScript for macOS) to guarantee wallpaper application even when module binaries are restricted. Improved module bundling and cross-platform consistency.</p>
               </div>
            </div>
